...
func (h *Handler) RegisterRoutes(r *gin.Engine, authMiddleware ...gin.HandlerFunc) {
	...
	api.GET("/projects/:id/blueprint/chapter-outlines", h.ListChapterOutlines)
	api.PUT("/blueprints/:id", h.UpdateBlueprint)
	...
	api.POST("/projects/:id/chapters/prompt-preview", h.PreviewChapterPrompt)
	api.POST("/projects/:id/chapters/generate", h.GenerateChapter)
	api.POST("/projects/:id/chapters/continue", h.ContinueGenerate)
	api.POST("/chapters/:id/prompt-preview", h.PreviewChapterRegeneratePrompt)
	...
	api.GET("/projects/:id/references/sites", h.ListReferenceNovelSites)
	...
	api.POST("/projects/:id/references/resolve-url", h.ResolveReferenceNovelURL)
