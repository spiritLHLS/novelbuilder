...
{{
  "characters": [
    {{
      "name": "人物姓名",
      "role": "主角/配角/反派/其他",
      "description": "人物简介（100字以内）",
      "traits": "性格特点1，性格特点2，性格特点3",
      "motivation": "人物核心动机（50字以内）",
      "growth_arc": "成长历程简述（50字以内）",
      "relationships": "角色A：关系描述；角色B：关系描述"
    }}
  ],
  "world_setting": "世界背景描述（200字以内）",
  "world_time_period": "时代背景",
  "world_locations": "场景地点1；场景地点2；场景地点3",
  "world_systems": "体系1（如修炼体系）；体系2（如魔法体系）",
  "outline": [
    {{
      "level": "macro",
      "title": "卷/篇/大情节标题",
...
[{{"name":"...","role":"...","description":"...","traits":"特点1，特点2","motivation":"...","growth_arc":"...","relationships":"角色A：关系；角色B：关系"}}]

原始数据：
{data}

要求：
1. 同名或明显相同的人物合并为一条，description/traits/motivation/growth_arc/relationships取并集最全版本
...
[{{"content":"...","related_characters":["角色名1","角色名2"],"priority":3}}]
