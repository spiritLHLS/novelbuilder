...
{{
  "characters": [
    {{
      ...
      "relationships": [
        {{"name": "另一角色姓名", "description": "关系描述（20字以内）"}}
      ]
    }}
  ],
  "world": {{
  ...
  "outline": [
    {{
      ...
      "title": "卷/篇/大情节标题",
      "summary": "内容概要（50字以内）",
      "involved_characters": ["涉及角色名1", "涉及角色名2"]
    }},
    {{
      "level": "meso",
      "title": "章节/情节节点标题",
      "summary": "内容概要（50字以内）",
      "involved_characters": ["涉及角色名1"]
    }},
    {{
      "level": "micro",
      "title": "场景/细节标题",
...
3. outline：尽量完整，macro级别为卷/大情节，meso级别为章节级，micro级别为场景级
4. glossary：本片段出现的所有专有名词，越完整越好
5. foreshadowings：本片段中设置的所有伏笔，越完整越好
6. 严格返回JSON，不要任何其他文字
...
[{{"name":"...","role":"...","description":"...","traits":["..."],"motivation":"...","growth_arc":"...","relationships":[{{"name":"...","description":"..."}}]}}]
