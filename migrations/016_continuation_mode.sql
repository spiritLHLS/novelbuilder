...
ALTER TABLE projects
    ADD COLUMN IF NOT EXISTS project_type         VARCHAR(20) NOT NULL DEFAULT 'original',  -- original | continuation
    ADD COLUMN IF NOT EXISTS continuation_ref_id  UUID REFERENCES reference_materials(id) ON DELETE SET NULL;
...
ALTER TABLE projects
    ADD COLUMN IF NOT EXISTS continuation_start_chapter INT NOT NULL DEFAULT 1;
